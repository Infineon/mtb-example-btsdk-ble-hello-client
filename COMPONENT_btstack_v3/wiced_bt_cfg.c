 ...
 ******************************************************************************/
extern char hello_client_local_name[];

/******************************************************************************
 *  Imported Function Declartions
 ******************************************************************************/
extern wiced_result_t   hello_client_management_cback( wiced_bt_management_evt_t event,
...
const wiced_bt_cfg_ble_t wiced_bt_cfg_ble =
{
    ...
    .p_ble_scan_cfg = &wiced_bt_cfg_scan_settings,                              /**< BLE SCAN Setting */
    .p_ble_advert_cfg = &wiced_bt_cfg_adv_settings,                             /**< BLE ADV Setting */
...
{
    .device_name = (uint8_t*)hello_client_local_name,                           /**< Local device name (NULL terminated). Use same as configurator generated string.*/
